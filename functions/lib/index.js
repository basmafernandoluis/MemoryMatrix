...
exports.sendTestNotification = exports.updateChallengeStats = exports.cleanupExpiredChallenges = exports.cleanupOldNotifications = exports.sendPushNotification = void 0;
    ...
    try {
        ...
        const message = {
            ...
            data: {
                ...
                score: ((_a = notification.score) === null || _a === void 0 ? void 0 : _a.toString()) || '',
                isWinner: ((_b = notification.isWinner) === null || _b === void 0 ? void 0 : _b.toString()) || '',
            },
            android: {
                priority: 'high',
                notification: {
 ...
 */
exports.updateChallengeStats = functions.firestore
