...
const slides: OnboardingSlide[] = [
  ...
  },
  {
    ...
    description: 'Classique, Survie, Contre-la-Montre, Zen et Personnalisé. Chaque mode offre une expérience différente !',
    tip: 'Débloquez les modes en progressant dans le jeu',
  },
  {
    id: 3,
    emoji: '�🎯',
  ...
  },
  {
    ...
    description: 'Mode Classique et Contre-la-Montre : 3 vies. Modes Survie et Zen : vie infinie pour une expérience relaxante.',
